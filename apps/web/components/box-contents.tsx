...
export function BoxContents() {
  return (
    <section className="mt-14">
      ...
      <ul className="mt-6 flex flex-wrap border-l border-t border-line">
        {BOX_CONTENTS.map((item) => (
          <li
            key={item}
            className="flex w-full items-start gap-3 border-b border-r border-line bg-paper p-5 sm:w-1/2 lg:w-1/3"
          >
